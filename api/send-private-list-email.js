...
function buildAdminEmail({ email, customerName, preferredStyle, language }) {
  ...
  const cleanName = escapeHtml(customerName || "Not provided");
  const cleanStyle = escapeHtml(preferredStyle || "Not selected");
  const cleanLanguage = escapeHtml(language || "EN");
...
<html>
  <head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>New La Grazia Private List Signup</title>
  </head>
  <body style="margin:0;background:#f7f1e8;font-family:Arial,Helvetica,sans-serif;color:#2c1f18;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
      A new client has joined the La Grazia Private List.
    </div>

    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f7f1e8;padding:34px 14px;">
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#fffaf2;border:1px solid #e4cfaa;border-radius:30px;overflow:hidden;box-shadow:0 24px 80px rgba(44,31,24,.14);">
            
            <tr>
              <td style="background:linear-gradient(135deg,#1f1712 0%,#3a281f 55%,#5a3d2b 100%);padding:44px 34px;text-align:center;">
                <div style="font-family:Georgia,'Times New Roman',serif;color:#fffaf2;font-size:38px;letter-spacing:10px;line-height:1;">
                  LA GRAZIA
                </div>
                <div style="color:#d8bd87;font-size:11px;letter-spacing:5px;text-transform:uppercase;margin-top:14px;">
            ...
            <tr>
              <td style="padding:42px 36px;text-align:center;">
                <div style="display:inline-block;background:#f6ead8;border:1px solid #e4cfaa;color:#8b6b38;border-radius:999px;padding:9px 18px;font-size:11px;letter-spacing:3px;text-transform:uppercase;margin-bottom:22px;">
                  New Client Joined
                </div>

                <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:34px;line-height:1.15;font-weight:400;margin:0 0 14px;color:#1f1712;">
                  A new woman joined the Private List.
                </h1>

                <p style="font-size:15px;line-height:1.8;color:#6b5648;margin:0 auto 30px;max-width:500px;">
                  A new customer has requested early access to La Grazia city drops, private styling edits, and limited seasonal pieces.
                </p>

                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f6ead8;border:1px solid #e4cfaa;border-radius:22px;overflow:hidden;text-align:left;">
                  <tr>
                    <td style="padding:22px 24px;border-bottom:1px solid #e4cfaa;">
                      <div style="font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#b08a45;margin-bottom:7px;">Client Name</div>
                      <div style="font-family:Georgia,'Times New Roman',serif;font-size:24px;color:#1f1712;">${cleanName}</div>
                    </td>
                  </tr>

                  <tr>
                    <td style="padding:22px 24px;border-bottom:1px solid #e4cfaa;">
                      <div style="font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#b08a45;margin-bottom:7px;">Email Address</div>
                      <a href="mailto:${cleanEmail}" style="font-size:16px;color:#2c1f18;text-decoration:none;">${cleanEmail}</a>
                    </td>
                  </tr>

                  <tr>
                    <td style="padding:22px 24px;border-bottom:1px solid #e4cfaa;">
                      <div style="font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#b08a45;margin-bottom:7px;">Preferred Style</div>
                      <div style="font-size:17px;color:#2c1f18;">${cleanStyle}</div>
                    </td>
                  </tr>

                  <tr>
                    <td style="padding:22px 24px;">
                      <div style="font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#b08a45;margin-bottom:7px;">Language</div>
                      <div style="font-size:17px;color:#2c1f18;">${cleanLanguage}</div>
                    </td>
                  </tr>
                </table>

                <table role="presentation" cellspacing="0" cellpadding="0" align="center" style="margin:32px auto 0;">
                  <tr>
                    <td style="background:#2c1f18;border-radius:999px;">
                      <a href="mailto:${cleanEmail}" style="display:inline-block;padding:16px 30px;color:#fffaf2;text-decoration:none;font-size:12px;letter-spacing:3px;text-transform:uppercase;">
                        Contact Client
                      </a>
                    </td>
                  </tr>
                ...
                <p style="font-size:13px;line-height:1.7;color:#8b6b38;margin:30px 0 0;">
                  Add her to the next drop preview, styling broadcast, or private WhatsApp follow-up.
                </p>
              </td>
            </tr>

            <tr>
              <td style="padding:22px 28px;text-align:center;background:#2c1f18;color:#d8bd87;font-size:11px;letter-spacing:2px;text-transform:uppercase;">
                Roma Drop · New Season Arrivals · Limited Seasonal Pieces
              </td>
            </tr>
